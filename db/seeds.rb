...
Rating.find_or_create_by(user: lina, hat_pic: lina_hat_pic2, score: 2)
Rating.find_or_create_by(user: dick, hat_pic: dick_hat_pic1, score: 3)
Rating.find_or_create_by(user: dick, hat_pic: dick_hat_pic2, score: 1)
Rating.find_or_create_by(user: dick, hat_pic: dick_hat_pic3, score: 5)
Rating.find_or_create_by(user: diego, hat_pic: diego_hat_pic1, score: 5)
Rating.find_or_create_by(user: diego, hat_pic: diego_hat_pic2, score: 5)
Rating.find_or_create_by(user: genevieve, hat_pic: genevieve_hat_pic1, score: 3)
Rating.find_or_create_by(user: liam, hat_pic: liam_hat_pic1, score: 5)
